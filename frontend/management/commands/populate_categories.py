...
class Command(BaseCommand):
    ...
    def get_category_icon_and_color(self, name):
        ...
        if any(
            word in name_lower for word in ["restoran", "kafe", "fast-food", "ovqat"]
        ):
            return (
            ...
            word in name_lower
            for word in ["it", "texnologiya", "dasturlash", "konsalting", "raqamli"]
        ):
            return (
            ...
            word in name_lower for word in ["tibbiyot", "klinika", "dorixona", "health"]
        ):
            return (
            ...
            word in name_lower for word in ["ta'lim", "maktab", "universitet", "kurs"]
        ):
            return (
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>',
                "orange",
            ...
            word in name_lower
            for word in ["avtomobil", "automotive", "transport", "avto"]
        ):
            return (
            ...
            word in name_lower for word in ["qurilish", "construction", "materiallari"]
        ):
            return (
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>',
                "orange",
            ...
            word in name_lower for word in ["telekommunikatsiya", "operator", "mobile"]
        ):
            return (
            ...
            word in name_lower for word in ["energetika", "energy", "electricity"]
        ):
            return (
            ...
            word in name_lower for word in ["to'qimachilik", "textile", "fashion"]
        ):
            return (
            ...
            word in name_lower
            for word in ["metallurgiya", "metal", "mining", "konchilik"]
        ):
            return (
            ...
            return (
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v6a2 2 0 002 2h2m2-2V9a2 2 0 012-2h2a2 2 0 012 2v.01M15 8v.01"/>',
                "green",
            )
            ...
            word in name_lower
            for word in ["logistika", "yetkazib", "delivery", "eksport"]
        ):
            return (
                '<path d="M14 18V6C14 5.45 13.55 5 13 5H11C10.45 5 10 5.45 10 6V18L7 21L12 19L17 21L14 18Z"/>',
                "orange",
            )
        elif any(word in name_lower for word in ["oil", "gas", "neft"]):
            return (
                '<path d="M9 2V13C9 14.1 9.9 15 11 15H13C14.1 15 15 14.1 15 13V2H9Z"/><path d="M12 15V22"/>',
                "gray",
            )
    ...
    def handle(self, *args, **options):
        ...
        if options["from_companies"]:
            ...
            company_categories = Company.objects.values_list(
                "category", flat=True
            ).distinct()
            company_categories = [
                cat for cat in company_categories if cat and cat.strip()
            ]
            ...
            for i, cat_name in enumerate(sorted(company_categories), 1):
                ...
                category, created = Category.objects.get_or_create(
                    name=cat_name, defaults=category_data
                )
